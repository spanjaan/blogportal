...
class CreateCommentsTable extends Migration
{
    ...
    public function down()
    {
        ...
        if (method_exists(Schema::class, 'dropColumns')) {
            Schema::dropColumns('rainlab_blog_posts', ['spanjaan_blogportal_comment_mode', 'spanjaan_blogportal_comment_visible']);
        } else {
            Schema::table('rainlab_blog_posts', function (Blueprint $table) {
                if (Schema::hasColumn('rainlab_blog_posts', 'spanjaan_blogportal_comment_mode')) {
                    $table->dropColumn('spanjaan_blogportal_comment_mode');
                }
            });
            Schema::table('rainlab_blog_posts', function (Blueprint $table) {
                if (Schema::hasColumn('rainlab_blog_posts', 'spanjaan_blogportal_comment_visible')) {
